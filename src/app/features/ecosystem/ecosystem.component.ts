...
const INTEGRATION_DATA: Record<Lang, { description: string; features: string[] }[]> = {
  fr: [
    { description: 'Base de données Postgres, authentification, Edge Functions et stockage. Utilisé pour les projets full-stack générés par la Swarm.', features: ['Postgres managé', 'Auth intégrée', 'Edge Functions', 'Migrations automatiques'] },
    { description: 'Déploiement continu, CDN global, serverless functions. Cible de déploiement par défaut pour les projets frontend.', features: ['Déploiement Git auto', 'CDN global', 'Preview deployments', 'Analytics intégrés'] },
    { description: 'Hébergement de services web, cron jobs, Postgres managé. Utilisé pour les backends et bases de données.', features: ['Web services', 'Cron jobs', 'Postgres', 'Key-Value stores'] },
    { description: 'Tests end-to-end cross-browser. Intégré au pipeline Swarm pour valider chaque PR sur Chromium et mobile (iPhone 14).', features: ['Tests multi-navigateurs', 'Auto-waiting', 'Visual comparisons', 'iPhone 14 simulé'] },
    { description: 'Recherche de documentation temps réel pour tous les frameworks et bibliothèques. Résout les Library ID et interroge la doc à jour pour éviter les APIs obsolètes.', features: ['Recherche documentation', 'Résolution Library ID', 'APIs à jour', 'Multi-framework'] },
    { description: 'Génération de composants UI via IA. Recherche, inspiration et raffinement de composants React/Next.js avec design system intégré.', features: ['Génération composants', 'Recherche UI', 'Inspiration design', 'Refinement visuel'] },
  ],
  en: [
    { description: 'Postgres database, authentication, Edge Functions, and storage. Used for full-stack projects generated by the Swarm.', features: ['Managed Postgres', 'Built-in Auth', 'Edge Functions', 'Automatic Migrations'] },
    { description: 'Continuous deployment, global CDN, serverless functions. Default deployment target for frontend projects.', features: ['Auto Git Deploy', 'Global CDN', 'Preview Deployments', 'Built-in Analytics'] },
    { description: 'Web service hosting, cron jobs, managed Postgres. Used for backends and databases.', features: ['Web Services', 'Cron Jobs', 'Postgres', 'Key-Value Stores'] },
    { description: 'Cross-browser end-to-end testing. Integrated into the Swarm pipeline to validate each PR on Chromium and mobile (iPhone 14).', features: ['Multi-browser Tests', 'Auto-waiting', 'Visual Comparisons', 'Simulated iPhone 14'] },
    { description: 'Real-time documentation search for all frameworks and libraries. Resolves Library IDs and queries up-to-date docs to avoid obsolete APIs.', features: ['Documentation Search', 'Library ID Resolution', 'Up-to-date APIs', 'Multi-framework'] },
    { description: 'AI-powered UI component generation. Search, inspiration, and refinement of React/Next.js components with integrated design system.', features: ['Component Generation', 'UI Search', 'Design Inspiration', 'Visual Refinement'] },
  ],
};
