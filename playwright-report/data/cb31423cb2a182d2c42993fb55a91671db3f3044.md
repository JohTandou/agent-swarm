...
- Name: responsive-cross-section.spec.ts >> T18 — Responsive cross-section (desktop + mobile) >> Desktop large — 1920×1080 >> la grille hexagonale est visible sur grand écran
- Location: e2e/responsive-cross-section.spec.ts:101:9
...
Call log:
  ...
  - waiting for locator('.hex-grid__canvas')
    24 × locator resolved to <canvas width="0" height="0" aria-hidden="true" class="hex-grid__canvas" _ngcontent-ng-c826910434=""></canvas>
