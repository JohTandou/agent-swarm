...
- Name: responsive-cross-section.spec.ts >> T18 — Responsive cross-section (desktop + mobile) >> Mobile — iPhone 14 (390×844) >> [Mobile] Workflow — le hamburger est présent
...
- main:
  ...
  - region "Le Pipeline Swarm":
    ...
    - text: 5 routes de complexité 10 agents spécialisés ≥ 80 % couverture de tests garantie
